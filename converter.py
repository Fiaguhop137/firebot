to_convert={"heat_wave":{"name":"Heat Wave","damage":17,"cooldown":2,"type":"fire","level":"basic"},
...
for item in to_convert:
    print('{"'+item+'",{"'+to_convert[item]["name"]+'",'+str(to_convert[item]["damage"])+','+str(to_convert[item]["cooldown"])+',"'+to_convert[item]["type"]+'","'+to_convert[item]["level"]+'"}},')